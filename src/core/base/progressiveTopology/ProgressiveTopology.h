...
#define PARALLEL_SORT std::sort
  ...
  public:
    ...
    // struct AdaptivePersistencePair {
    //   /** first (lower) vertex id */
    //   ttk::SimplexId birth{};
    //   /** first vertex type */
    //   ttk::CriticalType birthType{};
    ...
    //   /** second vertex type */
    //   ttk::CriticalType deathType{};
    //   /** persistence value in double**/
    //   double persistence{};
    //   /** pair type (min-saddle: 0, saddle-saddle: 1, saddle-max: 2) */
    //   ttk::SimplexId pairType{};

    //   AdaptivePersistencePair() = default;
    //   AdaptivePersistencePair(const SimplexId b,
    //                           const SimplexId d,
    //                           const double pers,
    //                           const SimplexId pType)
    //     : birth{b}, death{d}, persistence{pers}, pairType{pType} {
    //   }
    // };
  ...
  public:
    ...
    template <typename scalarType>
    int computeProgressivePDAdaptive(std::vector<PersistencePair> &CTDiagram,
                                     const scalarType *scalars,
    ...
    void setEpsilon(double data) {
      epsilon_ = std::max(0.0, std::min(1.0, data));
    }
    double getEpsilon() const {
      return epsilon_;
    }
    void setNbBuckets(int data) {
      nbWantedFeatures_ = std::max(data, 0);
    }
  ...
  public:
    ...
    int executeAdaptive(std::vector<PersistencePair> &CTDiagram,
                        const scalarType *inputScalars,
    ...
    template <typename scalarType>
    int executeCPProgressiveAdaptive(const scalarType *scalars,
                                     scalarType *fakeScalars,
  ...
  protected:
    ...
    template <typename scalarType, typename offsetType>
    void initCriticalPointsAdaptive(
      std::vector<polarity> &isNew,
      std::vector<std::vector<std::pair<polarity, polarity>>>
        &vertexLinkPolarity,
      std::vector<polarity> &toPropageMin,
    ...
    template <typename scalarType, typename offsetType>
    void initGlobalPolarityAdaptive(
      std::vector<polarity> &isNew,
      std::vector<std::vector<std::pair<polarity, polarity>>>
        &vertexLinkPolarity,
      std::vector<polarity> &toProcess,
    ...
    template <typename scalarType, typename offsetType>
    void updatePropagationCPAdaptive(
      std::vector<polarity> &toPropageMin,
      std::vector<polarity> &toPropageMax,
      std::vector<std::vector<SimplexId>> &vertexRepresentativesMin,
      std::vector<std::vector<SimplexId>> &vertexRepresentativesMax,
    ...
    template <typename scalarType, typename offsetType>
    void buildVertexLinkPolarityAdaptive(
      const SimplexId vertexId,
      std::vector<std::pair<polarity, polarity>> &vlp,
      const scalarType *fakeScalars,
      const offsetType *const offsetField,
    ...
    template <typename ScalarType, typename OffsetType>
    void sortTripletsAdaptive(std::vector<triplet> &triplets,
                              const ScalarType *const scalars,
    ...
    template <typename scalarType, typename offsetType>
    void tripletsToPersistencePairsAdaptive(
      std::vector<PersistencePair> &pairs,
      std::vector<std::vector<SimplexId>> &vertexRepresentatives,
      std::vector<triplet> &triplets,
      const scalarType *const scalars,
    ...
    template <typename scalarType, typename offsetType>
    void
      getCriticalTypeAdaptive(const SimplexId &vertexId,
                              std::vector<std::pair<polarity, polarity>> &vlp,
                              uint8_t &vertexLink,
                              DynamicTree &link,
                              VLBoundaryType &vlbt,
    ...
    template <typename ScalarType, typename offsetType>
    int updateGlobalPolarityAdaptive(
      double eps,
      std::vector<polarity> &isNew,
    ...
    template <typename ScalarType, typename offsetType>
    void computeCriticalPointsAdaptive(
      std::vector<std::vector<std::pair<polarity, polarity>>>
        &vertexLinkPolarity,
      std::vector<polarity> &toPropageMin,
      std::vector<polarity> &toPropageMax,
    ...
    template <typename ScalarType, typename offsetType>
    void reComputeCriticalPointsAdaptive(
      std::vector<std::vector<std::pair<polarity, polarity>>>
        &vertexLinkPolarity,
      std::vector<polarity> &toPropageMin,
      std::vector<polarity> &toPropageMax,
    ...
    template <typename ScalarType, typename offsetType>
    void updateCriticalPointsAdaptive(
      std::vector<std::vector<std::pair<polarity, polarity>>>
        &vertexLinkPolarity,
      std::vector<polarity> &toPropageMin,
      std::vector<polarity> &toPropageMax,
    ...
    template <typename scalarType, typename offsetType>
    bool processBucketOnLastLevelAdaptive(
      double eps,
      size_t &start_index,
      std::vector<std::tuple<SimplexId, double, int>> &globalErrorList,
      std::vector<polarity> &isNew,
    ...
    template <typename scalarType, typename offsetType>
    bool processHierarchicalBucketAdaptive(
      double eps,
      size_t &start_index,
      std::vector<std::tuple<SimplexId, double, int>> &globalErrorList,
      std::vector<polarity> &isNew,
    ...
    template <typename ScalarType, typename offsetType>
    int getMonotonyChangeByOldPointCPAdaptive(
      const SimplexId vertexId,
      double eps,
      const std::vector<polarity> &isNew,
      std::vector<polarity> &toProcess,
    ...
    template <typename scalarType, typename offsetType>
    bool updateLinkPolarityAdaptive(
      const SimplexId vertexId,
      std::vector<std::pair<polarity, polarity>> &vlp,
      const scalarType *fakeScalars,
      const offsetType *const offsets,
    ...
    template <typename scalarType, typename offsetType>
    ttk::SimplexId propageFromSaddlesAdaptive(
      const SimplexId vertexId,
      std::vector<Lock> &vertLock,
      std::vector<polarity> &toPropage,
      std::vector<std::vector<SimplexId>> &vertexRepresentatives,
    ...
    template <typename ScalarType, typename offsetType>
    void computePersistencePairsFromSaddlesAdaptive(
      std::vector<PersistencePair> &CTDiagram,
      const ScalarType *const scalars,
      const ScalarType *const fakeScalars,
      const offsetType *const offsets,
    ...
    template <typename scalarType>
    int sortPersistenceDiagramAdaptive(std::vector<PersistencePair> &diagram,
                                       const scalarType *const scalars,
                                       scalarType *fakeScalars,
    ...
    bool useStaticDelta_{false};
    bool useStaticReplacement_{};
    double epsilon_{};
    double delta_{};
    int nbWantedFeatures_{0};
    // _____________________________________________________
...
#include <ProgressiveTopologyAdaptive.h>
